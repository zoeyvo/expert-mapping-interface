    ...
    <div className="App">
      ...
      <nav className="flex items-center py-8 px-10 bg-white shadow-md">
        ...
        <div className="flex items-center space-x-8">
          <img src={aggieExpertsLogo} alt="Aggie Experts Logo" className="h-20 w-auto ml-4 mb-0" />
          <div className="flex items-center space-x-10">
            <a href="#" className="text-4xl font-semibold" style={{ color: '#022851' }}>Aggie Experts Interactive Map</a>
          </div>
        </div>
      </nav>
